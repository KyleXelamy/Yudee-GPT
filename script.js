...
const responseDatabase = [
    ...
    { user: "What's your name", bot: "I'm Kyle-GPT, your friendly chat assistant. What's your name?" },
    ...
    { user: "What's your favorite parasailing spot", bot: "Many people love parasailing in the Bahamas. What's your favorite parasailing spot?" }
   ];

    // Placeholder for ChatGPT API token
    let chatGptApiToken = ""; // Set your API token here when available
    ...
    function botResponse(userInput) {
        ...
        // Check response database for a match
        ...
        // If no response found in database, attempt to use ChatGPT API if available
    ...
    async function sendMessage() {
        ...
        const userMessageElement = createUserMessage(messageText);
        chatWindow.appendChild(userMessageElement);

        // Get bot response
        const botMessageText = await botResponse(messageText);
        const botMessageElement = createBotMessage(botMessageText);
    ...
    async function getResponseFromChatGPT(userInput) {
        // Check if ChatGPT API token is set and make API call
        if (chatGptApiToken) {
            try {
            ...
            // If API token is not set, return a message indicating so
